...
| `release` | the release commit itself (created by `release.mjs`) | `chore(release): v0.9.0-beta.4` |
...
```bash
npm run release -- beta                    # next beta iteration (0.9.0-beta.4 -> 0.7.0-beta.2)
...
npm run release -- 0.9.0-beta.4            # or spell out the full version
