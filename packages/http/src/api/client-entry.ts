/**
 * MODULE: api/client-entry - the browser-safe subset ('@azerothjs/http/api/client')
 *
...
export { defineContract, route, get, post, put, patch, del, query, guard, multipart } from './define.ts';
export type { Contract, AnyRoute, Route, RouteDocs, ApiMethod, PathParams, Guard, GuardContext, MultipartInput, MultipartConfig, ContractFile } from './define.ts';
