...
//
// Realistic end-to-end exercise of azerothjs. Two angles:
...
import { createRoot, h, render, createForm, combine, required, minLength, email } from 'azerothjs';
import type { FormApi } from 'azerothjs';
